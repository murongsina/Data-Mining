...
RParams = {
    ...
    struct('Name', 'LSTWSVR_Mei', 'C1', C1, 'eps1', EPS1, 'kernel', kernel);...
    ...
    struct('Name', 'MTLS_TWSVR', 'C1', C1, 'eps1', EPS1, 'rho', RHO, 'kernel', kernel);...
    struct('Name', 'LSTWSVR_Xu', 'C1', C1, 'eps1', EPS1, 'kernel', kernel);...
    struct('Name', 'MTLS_TWSVR_Xu', 'C1', C1, 'eps1', EPS1, 'rho', RHO, 'kernel', kernel)...
};
...
%     struct('Name', 'ITWSVM', 'C1', C1, 'C3', C1, 'kernel', kernel);...
    ...
    struct('Name', 'DMTSVM', 'C1', C1, 'rho', RHO, 'kernel', kernel);...
